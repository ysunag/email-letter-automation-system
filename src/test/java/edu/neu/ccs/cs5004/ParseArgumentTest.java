...
public class ParseArgumentTest {
  ...
  public void checkArguments() {
    ...
    Assert.assertEquals(templateError + example, parseTest6.checkArguments());
    Assert.assertEquals(templateError + example, parseTest7.checkArguments());
    Assert.assertEquals(dirError + example, parseTest8.checkArguments());
    Assert.assertEquals(dirError + example, parseTest9.checkArguments());
    Assert.assertEquals(dirError + example, parseTest10.checkArguments());
    Assert.assertEquals(inputError + example, parseTest11.checkArguments());
    Assert.assertEquals(inputError + example, parseTest12.checkArguments());
    Assert.assertEquals(inputError + example, parseTest13.checkArguments());
  }

  @Test
  public void getAction() {
    Assert.assertEquals(new Email(), parseTest1.getAction());
  }
